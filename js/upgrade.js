document.addEventListener("DOMContentLoaded", function() {
    ...
    if (!manual) {
        ...
        if (userLang === "en") {
            if (window.location.href !== "https://en.gitsite.dev/upgrade") {
                window.location.replace("https://en.gitsite.dev/upgrade");
            }
        } else {
            if (window.location.href !== "https://gitsite.dev/upgrade") {
                window.location.replace("https://gitsite.dev/upgrade");
            }
        }
    }
});
